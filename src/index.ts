...
const buildPath: string = path.join(import.meta.dirname, "../build");
const themes: any[] = [TokyoNight, TokyoNightLight, TokyoNightStorm];
...
themes.forEach((theme) => {
  const colorSet: IColorSet = {
    ...
    // Overrides specific syntax scopes provided by the theme generator
    syntax: {
      boolean: theme.base.red,
      class: theme.base.purple,
      ...
      functionCall: theme.base.purple,
      ...
      type: theme.base.red,
      punctuation: theme.base.red,
      variable: theme.ui.foreground,
      number: theme.base.orange,
    },
    // Define the integrated shell color palette
    terminal: {
    ...
    ui: {
      ...
      // Highlights matches from the find widget
      findMatchHighlight: theme.base.red,
      ...
      wordHighlight: theme.base.red + "30",
    ...
    workbench: {
      ...
      "editor.findMatchBorder": theme.base.red,
      ...
      "activityBar.activeBorder": theme.base.red,
      ...
      "tab.activeModifiedBorder": theme.base.red,
      ...
      "editorOverviewRuler.findMatchForeground": theme.base.red,
      ...
      "input.foreground": theme.base.red,
      ...
      "diffEditor.removedTextBackground": theme.base.red + "20",
      ...
      "peekViewResult.matchHighlightBackground": theme.base.red + "50",
      "peekViewEditor.matchHighlightBackground": theme.base.red + "50",
      ...
      "breadcrumb.activeSelectionForeground": theme.base.red,
      ...
      "settings.modifiedItemIndicator": theme.base.red,
      "settings.checkboxBackground": theme.ui.background,
      "settings.checkboxForeground": theme.ui.foreground,
      // List Filter Widget style
      "listFilterWidget.background": theme.base.purple,
      "listFilterWidget.outline": theme.base.purple,
      "listFilterWidget.noMatchesOutline": theme.base.purple,
    },
  ...
  generateTheme(
    theme.name,
    colorSet,
    path.join(import.meta.dirname, `../build/${theme.name}.json`)
  );
});
